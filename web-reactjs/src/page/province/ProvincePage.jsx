...
function ProvincePage() {
  ...
  const getlist = async () => {
    ...
    const res = await request("province" + queryparam, "get");
    // console.log(res);
    if (res && !res.errors) {
      setState((pre) => ({
        ...pre,
  ...
  const onClickDelete = (item) => {
    Modal.confirm({
      ...
      onOk: async () => {
        ...
        try {
          const res = await request("province/" + item.id, "delete");
          if (res && !res.error) {
      ...
      <div>
        ...
        >
          <Form layout="vertical" onFinish={onFinish} form={formrefe}>
            ...
            {/* `id`, `name`, `code`, `region`, `population`, `area`, `description`, `created_at`, `updated_at` */}
            <Form.Item
              name="code"
              label="Code"
              {...validate.code}
            ...
            <Form.Item
              ...
              // rules={[{ required: true, message: "Name is required" }]}
            >
              <Input placeholder="Region" allowClear />
            </Form.Item>
            <Form.Item
              name="population"
              label="Population"
              ...
              // rules={[{ required: true, message: "Name is required" }]}
            >
              <Input placeholder="Population" allowClear />
            </Form.Item>
            <Form.Item
              name="area"
              label="Area"
              ...
              // rules={[{ required: true, message: "Name is required" }]}
            >
              <Input placeholder="Area" allowClear />
            </Form.Item>
